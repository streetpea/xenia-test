...
xvfb-run -a -- find ../build/bin/Linux/Release/ -executable -iname 'xenia*' -type f | xargs -i -t -exec ./lib4bin -p -v -r -e -s -k {} \
 ...
 install ../build/bin/Linux/Release/ .
